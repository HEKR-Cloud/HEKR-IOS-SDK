...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/HEKR-Cloud/HEKR-IOS-SDK.git", :tag => "SDK3.0" }
  ...
  #s.source_files  = "HekrSDK/Private/*.{h,m}", "HekrSDK/*.{h,m}"
  #s.exclude_files = "HekrSDK/CocoaAsyncSocket", "HekrSDK/Reachability", "HekrSDK/SocketRocket", "HekrSDK/WebViewJavascriptBridge", "HekrSDK/ZipArchive"
  ...
  s.vendored_libraries = 'libHekrSDK.a'
  ...
  s.dependency "TencentOpenApiSDK","~> 2.9"
  s.dependency "WeixinSDK","~> 1.4"
  s.dependency "FBSDKLoginKit", "~> 4.8"
  s.dependency "TwitterCore", "~> 1.10.0"
  s.dependency "TwitterKit", "~> 1.10.0"
  s.dependency "Google/SignIn", "~> 1.2"
  s.dependency "GetuiSDK"
